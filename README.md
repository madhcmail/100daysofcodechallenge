...
Day 39: #100DaysOfCode progress: Today I completed my code on the US weather dataset that I picked from FiveThirtyEight GitHub repository(https://github.com/fivethirtyeight/data). I was abel to parse the datset using CSV module, convert into usabel forma and then find answers to the top 5 hottest days, coldest and wettest days. Here is th e
