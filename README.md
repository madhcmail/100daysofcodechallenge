...
Day 80:#100DaysOfCode progress: Today I started learning about SQLAlchemy which is a popular SQL toolkit and Object Relational Mapper. With the ORM API of SQLAlchemy, we can associate  user-defined python classes in to database tables and objects of those classes with rows in their corresponding tables.
We no need to worry about writing the SQL code and all we need to define is python classes and objects. SQLAlchemy will take care of converting them into database queries and execute. With SQLAlchemy, you can connect to any RDMS and all you need to define is the URI for the specific database and the rest all same for all different types of databases.\
Day 81: #100DaysOfCode progress: Today I continued my learning on using SQLAlchemy  on how to query data, update a particular record in the table and explored different methods the Query object provides in SQLAlchemy. The engine that I am using is SQLite.\
Day82 & 83:#100DaysOfCode progress: Today I explored the SQLAlchemy extension for Flask python and tried to create a simple app with html forms and SQLite using SQLAlchemy extension and Flask framework. I am able to post the data from HTML form successfully but however the data was not able to get stored in the db. I will continue debugging the issue tomorrow.\
Day 84: #100DaysOfCode progress: Today I was able to troubleshoot the error that causing the data not to get stored in the DB even after the POST was successful. The issue is I haven't done initialization of my variables after I defined my table using db.Model class in SQLAlchemy-Flask.\
Day 85: #100DaysOfCode progress: Today I applied whatever I learned in the last couple of days about Flask, SQLAlchemy with SQLite engine to the Blog web app which I am creating.\
Day 86:#100DaysOfCode progress: Today I worked on re-organizing my web application project into a package structure rather than a modules and ensure all the modules are working as expected.\
Day 87 & 88: #100DaysOfCode progress: Last two days I created  a web page  addpost in the my web application where in I created a HTML Form, retrieved the Post elements and successfully stored into the database. Will be working on the other Delete and Update actions and add it to the application.\
Day 89: #100DaysOfCode progress: Today I worked on refactoring some of the code on add post html, rearranged and ensure all the html elements are rendered properly on my blog application.\
Day 90: #100DaysOfCode progress: Today I started learning on how to create a RESTFUL api using flask and jsonify. I found this useful link https://www.rithmschool.com/courses/flask-fundamentals/using-jsonify \
Day 91: #100DaysOfCode progress: Today I am able to create two Restful api's (/getCustomers,/getCustomers/<id>) where my data is retrieved from Sqlite database which was stored using Flask SqlAlchemy.\
Day 92: #100DaysOfCode progress: Today I practiced creating few more getAPIS for the previous programs that I have created. \
Day 93:#100DaysOfCode progress: Today I explored how to create a POSTAPI using Flask and used POSTMAN to post the data to a dictionary. I will  next explore on how to insert the data to a database by retrieving the values from POST API.\
Day 94:#100DaysOfCode progress: Today I was able to create a restful POST API to insert the data into database which was created using Flask Sqlalchemy. I will explore more on this on how to do bulk inserts using API.\
Day 95:#100DaysOfCode progress: Today I learned about how to create a PUT API request to overwrite/update any data that s stored.\
Day96&97: #100DaysOfCode progress: I was able to do bulk inserts to database by creating a RESTFUL POST API which converts a JSON file in to a python dictionary and inserts into the database successfully.\
Day 98: #100DaysOfCode progress: Today I created a RESTFUL DELETE API from a python dictionary and working on creating a DELETE API which deletes the data from the SQLite database using Flask SQLAlchemy.\
Day 99:#100DaysOfCode progress: Today I created a POST API which does bulk inserts into a database by passing a json file.\
Day100:#100DaysOfCode progress: Today is the last day of my 100 days of progress. I have  created a Weekly Meal Prep APP which prepares a weekly plan based on my meal menu and the   associated preferred food item. I used Python, random module, sqlite3 and Flask to build this app. I also created the API's (GET,POST and PUT) to perform the database transactions.
